...
function page() {
  ...
  const GetForms = async () => {
    try {
      const response = await axios("/api/consultant");
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="font-headline hidden sm:table-cell">Consultant</TableHead>
                      <TableHead className="font-headline hidden sm:table-cell">Selected Date</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                     ...
                     {data.map((item)=>(
                       <TableRow key={item._id} >
                        ...
                        <TableCell className="hidden md:table-cell">{item.consultant}</TableCell>
